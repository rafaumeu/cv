...
export const Header = () => (
  <header className="mb-6 sm:mb-8 text-center" role="banner">
    ...
    <h1 className="text-3xl sm:text-4xl font-bold text-gray-900" itemProp="name">
      Rafael Dias Zendron
    </h1>
    <h2 className="text-lg sm:text-xl text-blue-600 mt-2 sm:mt-4" itemProp="jobTitle">
      <FormattedMessage id="header.role" defaultMessage="Full Stack Developer" />
    </h2>
    <nav className="flex flex-col items-center mt-4 text-gray-600 text-sm sm:text-base" aria-label="Contato">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 w-full max-w-2xl">
        <a 
          href="tel:+5511964897587" 
          className="flex items-center justify-center sm:justify-start gap-1 hover:text-blue-600 transition-colors"
          aria-label="Telefone"
        >
